Rebol [
	...
	version: 0.0.2
	notes: {
		a working async version
		
		p: open smtp://mail.vendor.com
		read p ; and this should send your email as constructed below with basic authentication only supported
...
sys/make-scheme [
	...
	awake: func [event /local client response state code test] [
